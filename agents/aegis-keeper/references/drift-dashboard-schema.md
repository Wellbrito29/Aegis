...
- `Rodar /aegis-keeper after` (status `pending`)
- `Rodar /aegis-archaeologist` (drift estrutural ou stale)
- `Rodar /aegis-reviewer` (múltiplas specs afetadas)
- `Rodar /aegis-data-master` (mudança em schema)
