...
// Forward — active feature workspaces (created by /aegis-requirements)
export const FORWARD_DIR = join(AEGIS_ROOT, 'forward');
export const ACTIVE_REQUIREMENTS_JSON = join(CONFIG_DIR, 'active-requirements.json');
