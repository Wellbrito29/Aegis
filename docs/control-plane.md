...
|---|---|---|
| **Aegis Spec** | Spec authority — features, contracts, invariants, ADRs | `_aegis_sdd/` |
...
`_aegis_sdd/auto-policy.yaml`. See `docs/keeper-auto.md`.

## Files Aegis Spec adds to your repo

| Path | Purpose |
|---|---|
| `_aegis_sdd/sdd/*.md` | Specs with frontmatter (`contracts:`, `protected_files:`) |
| `_aegis_sdd/auto-policy.yaml` | Optional — enables auto mode |
| `_aegis_sdd/audit-policy.json` | Optional — declares fields to redact in the audit log |
