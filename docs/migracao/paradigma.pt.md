...
1. **Detecta** o paradigma do legado a partir das specs do `aegis/`. Procura por marcas concretas: estrutura de classes, padrões de acesso a dados, presença de eventos, fluxo síncrono linear, etc.
