...
| Arquivo | Conteúdo |
|---------|----------|
| `aegis/code-analysis.md` | Análise técnica consolidada |
| `aegis/data-dictionary.md` | Dicionário completo de dados |
| `aegis/flowcharts/[modulo].md` | Fluxograma em Mermaid por módulo |
