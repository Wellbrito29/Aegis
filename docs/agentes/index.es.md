...
Aegis Spec coordina un equipo de 14 especialistas. Cada agente hace una cosa y la hace bien.
...
|--------|------|----------|---------|
| [Aegis Spec](aegis.md) | Orquestación | El director de orquesta | Coordina todos los agentes, guarda checkpoints, guía al usuario |
...
| [Keeper](keeper.md) | El notario al lado | Después de cada cambio — mantiene specs sincronizadas con el código |
...
```
/aegis → orquesta todo automáticamente
