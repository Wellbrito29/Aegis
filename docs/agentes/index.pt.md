...
|--------|------|----------|--------|
| [Aegis Spec](aegis.md) | Orquestração | O regente de orquestra | Coordena todos os agentes, salva checkpoints e guia o usuário |
...
| [Keeper](keeper.md) | O tabelião ao lado | Após cada mudança de código — mantém specs sincronizadas com o código |
