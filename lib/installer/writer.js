...
export class Writer {
  ...
  // Cria a estrutura interna aegis/ (single-folder layout)
  ...
  // Copia body templates, scripts, hooks.yml e setup.json forward para aegis/
  ...
  _installForwardAssets(aegisDir, answers, version) {
    ...
    // setup.json → aegis/config/setup.json (com placeholders)
  ...
  // Refresca body templates, scripts e hooks.yml em aegis/ a partir do pacote npm,
  ...
  // Adiciona aegis/ e aegis/config/config.user.toml ao .gitignore
