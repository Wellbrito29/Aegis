...
1. **Detecta** el paradigma del legado a partir de las specs en `aegis/`. Busca marcas concretas: estructura de clases, patrones de acceso a datos, presencia de eventos, flujo síncrono lineal, etc.
