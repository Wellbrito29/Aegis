...
├── bin/                ← punto de entrada del CLI (aegis.js)
├── lib/
...
1. Crea la carpeta `agents/aegis-[nombre]/`
...
MIT. Ver [LICENSE](https://github.com/sandeco/aegis/blob/main/LICENSE) para los detalles.
