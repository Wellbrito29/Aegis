...
const SECTION_START = '# >>> aegis-keeper pre-commit fallback (do not edit between markers) >>>';
const SECTION_END = '# <<< aegis-keeper pre-commit fallback <<<';

function buildSection(runnerPath, engineId) {
  return [
    SECTION_START,
    '# Drains aegis/runtime/queue/keeper-queue.jsonl to a "stop" advisory.',
